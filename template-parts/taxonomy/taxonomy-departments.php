...
<?php $term = 'departments_'.get_queried_object()->term_id; ?>

<section class="top_baner_locations top_single_baner_services">
    <div class="center-all top_baner_content" style="background-image: url(<?php echo get_field('banner_image', $term); ?>);">
        <div class="baner_desc">
            <ul class="custom_breadcrump">
                <li><a href="/our-departments">Departments</a></li>
...
<?php if( !get_field('no_services', $term) ): ?>
<section class="service_list">
	<div class="heading">
		<h2>
			<?php echo get_queried_object()->name ?> Services
		</h2>
	</div>
    <div class="grid-wrap">
        <?php 
...
<section class="single_service_desc">
    <div class="flex-wrap">
        <div class="single_service_left">
            <?php 
                $single_service_image = get_field('thumbnail_image', $term);
                if( !empty( $single_service_image ) ): ?>
                    <img src="<?php echo $single_service_image; ?>" />
            <?php endif; ?>
        </div>
        <div class="single_service_right">
            <?php echo get_field('content', $term); ?>
        </div>
    </div>
</section>

<?php if( have_rows('faq_questions_and_answers', $term) ): ?>
<section class="questions_answers_wrap">
    <h2><?php echo get_field('faq_title', $term); ?></h2>

    <div id="accordion" class="accordion-container">


    
        <?php while( have_rows('faq_questions_and_answers', $term) ): the_row(); 
                    ...
                    <div class="post_content_wrap">
                        ...
                        <div class="post_desc">
                            ...
                            if( $link_address ): 
                                ...
                                ?>
                                <a class="button" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><p><span class="accessibility-hidden">Google Maps </span><?php echo esc_html( $link_title ); ?></p></a>
                            <?php endif; ?>
                        ...
                        <div class="blog_img">
                            <a href="<?php echo get_permalink( $pp->ID ); ?>">
                                <?php
                                    ...
                                    $url = $thumb['0'];
                                ?>
                                <img src="<?=$url?>" alt="<?= get_the_title( $pp->ID ) ?>">  
                            </a>  
                        </div>
